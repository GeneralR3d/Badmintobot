...
newdata = data[(data['time']<TIME_INTERVAL*5)]


def main():
    with open('../models/trained_model_snippet.pkl', 'wb') as file:
        gbm=train()
...
def train():
    X = newdata[["time","LocationX","LocationY","LocationZ", "LaunchX", "LaunchY", "LaunchZ", "LaunchAngle", "LaunchDirection", "InitialV"]]
